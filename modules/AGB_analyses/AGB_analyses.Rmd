...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'AGB_analyses', path = '..')$version`"
...
```{r setup-AGB-analyses, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "AGB_analyses", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-AGB-analyses, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("AGB_analyses", "..")
knitr::kable(df_inputs,
             caption = "List of (ref:AGB-analyses) input objects and their description.") |>
...
```{r moduleParams-AGB-analyses, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("AGB_analyses", "..")
knitr::kable(df_params, caption = "List of (ref:AGB-analyses) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-AGB-analyses, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("AGB_analyses", "..")
knitr::kable(df_outputs, caption = "List of (ref:AGB-analyses) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
