...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'AGB_dataPrep', path = '..')$version`"
...
```{r setup-AGB-dataPrep, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "AGB_dataPrep", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-AGB-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("AGB_dataPrep", "..")
knitr::kable(df_inputs,
             caption = "List of (ref:AGB-dataPrep) input objects and their description.") |>
...
```{r moduleParams-AGB-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("AGB_dataPrep", "..")
knitr::kable(df_params, caption = "List of (ref:AGB-dataPrep) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-AGB-dataPrep, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("AGB_dataPrep", "..")
knitr::kable(df_outputs, caption = "List of (ref:AGB-dataPrep) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
